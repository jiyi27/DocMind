...
CREATE_API_KEYS_USER_CREATED_AT_INDEX = """
CREATE INDEX IF NOT EXISTS idx_api_keys_user_created_at
ON api_keys (user_id, created_at DESC);
"""

CREATE_API_KEY_USAGE_KEY_DATE_INDEX = """
CREATE INDEX IF NOT EXISTS idx_api_key_usage_key_date
ON api_key_usage (key_id, used_date DESC);
"""
